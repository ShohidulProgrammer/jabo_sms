...
class HistoryDetails extends StatelessWidget {
  ...
  HistoryDetails({@required this.mobile});
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              ...
              myAlertDialog(
                  context: context, title: title, desc: desc, mobile: mobile);
            },
          ),
        ],
      ),
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(
              children: <Widget>[
                Flexible(
                  child: StreamBuilder<List<SmsHistoryModel>>(
//                      stream: _repository.getAllMessageHistory(mobile: mobile),
                      stream: historyBloc.getMessages(mobile: mobile),
                      builder: (context,
